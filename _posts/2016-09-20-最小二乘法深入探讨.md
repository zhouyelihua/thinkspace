...
$$\mathbf{\phi}\mathbf{\theta}=  \left[\begin{vmatrix}\phi(x_1)&\\\vdots&\\\phi(x_n)&\\\end{vmatrix}\right]\mathbf{\theta}=\left[\begin{vmatrix}\phi(x_{11})&\phi(x_{12})&\cdots&\phi(x_{1n})\\\vdots&\\\phi(x_{m1})&\phi(x_{m2})&\cdots&\phi(x_{mn})\\\end{vmatrix}\right] \left[\begin{vmatrix}\phi(\theta_1)&\\\vdots&\\\phi(\theta_n)&\\\end{vmatrix}\right]$$
